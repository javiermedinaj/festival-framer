...
const Hero: React.FC = () => {
  return (
    <section className="w-full pt-16 bg-black text-white relative overflow-hidden">
      <div
          ...
          >
            ...
            >
              ...
              <span className="block text-white">
                LINE UP <span className="text-white">por día!</span>
              </span>
            </motion.h1>
            ...
            >
              ...
              >
                <a href="https://home.passline.com/" target="_blank">
                  Comprar Entradas
                </a>
              </motion.button>
              ...
              >
                <Link to="/lineup">Ver Line Up</Link>
              </motion.button>
            </motion.div>
          </motion.div>
