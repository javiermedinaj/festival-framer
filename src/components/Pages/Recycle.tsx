...
const Recycle = () => {
  return (
    <div className="bg-white pb-0 text-black overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {[
              {
                big: "800KG",
                title: "PET TRITURADO EN BICICLETAS",
                small: "(45.000 botellas plásticas)",
              },
              {
                big: "860LTS",
                title: "ACEITE RECOLECTADO",
                small:
                  "(695Lts de materia prima para la producción de bioenergías)",
              },
              {
                big: "6U",
                title: "TORRES SOLARES",
                small: "(evitó consumir 324lts de combustible fósil)",
              },
              {
                big: "900U",
                title: '"BOTELLAS DE AMOR"',
                small: "(587kg de plásticos)",
              },
              {
                big: "350MTS",
                title: "TELA MESH UTILIZADA",
                small: "(1.000 totebags)",
              },
              {
                big: "100U",
                title: "PRENDAS FABRICADAS REUTILIZANDO COLECCIONES ANTERIORES",
                small: "",
              },
              {
                big: "30.000U",
                title: "COLILLAS DE CIGARRILLOS RECOLECTADAS",
                small: "",
              },
              ...
              <div key={idx} className="text-left">
                ...
                <div className="border-t border-black pt-3">
                  ...
                  {item.small && (
                    <div className="text-1xl text-gray-600 mt-1">
                      {item.small}
                    </div>
                  )}
                </div>
      ...
      <img src={Wave4} alt="Wave" className="w-full h-auto block" />
      {/* section 4 */}
      <div className="bg-black text-white text-center py-12 px-6">
        <h2 className="text-6xl text-emerald-500 font-extrabold mb-6">
          ¿QUÉ MUNDO HACEMOS?
        </h2>
        <p className="text-lg mb-4">100.000 BOTELLAS PET RECICLADAS </p>

        <p className="text-2xl mb-4 text-center max-w-3xl mx-auto">
          Con una mega instalación de “arte reciclable” junto con la ONG
          ambiental QI Argentina y la artista Mónica Casella, nos propusimos
          interpelar y generar conciencia, a través de estas obras realizadas
          íntegramente con residuos plásticos.
        </p>
        <div className="flex justify-center items-center pt-20">
          <img src={Derrame} alt="Derrame" className="max-w-4xl h-auto" />
        </div>
      </div>
        ...
        <div className="relative min-h-screen">
          ...
          <div className="absolute inset-0 flex items-center justify-center z-10 px-4 py-20 md:py-32">
            <div className="text-center text-white max-w-5xl w-full">
              ...
              <div className="space-y-4 text-1xl sm:text-base md:text-lg leading-relaxed px-4">
                <p className="lg:text-4xl text-white">
                  Miles de fans se unieron a la causa, llenando botellas con
                  plásticos de un solo uso y dándoles una segunda vida. Previo
                  al festival del año 2024, los participantes entregaron en los
                  puntos de retiro de entradas, Unicenter y La Rural, una enorme
                  cantidad de botellas.
                </p>

                <p className="text-1xl text-white">
                  Gracias a esta acción creamos una montaña de material
                  reciclable con el objetivo de transformarlo en mobiliario para
      ...
      <section className="bg-black text-white py-10 md:py-32 px-6">
        ...
        <img
          src={Wave8}
          alt="Wave"
          className="w-full h-auto block pt-30"
          style={{ display: "block", marginBottom: "-1px" }}
        />
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div className="text-left">
              ...
              <h3 className="text-emerald-400 text-4xl md:text-6xl lg:text-7xl font-black">
