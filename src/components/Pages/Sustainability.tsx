          ...
          >
            <p>
              <strong className="text-3xl">
                Reducir el impacto del festival sobre el ambiente es un objetivo
                y un compromiso que nos guía.
              </strong>
            </p>
            <p className="text-2xl text-gray-900">
              En nuestra próxima edición, Enchastre vuelve a ser el punto de
              encuentro de miles de fanáticos, donde juntos seguiremos
              construyendo una cultura de respeto y cuidado, disfrutando de la
              música en vivo y promoviendo prácticas sostenibles.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            >
              <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter leading-tight mb-6">
                LA SOST<span className="text-yellow-400">E</span>NIBILIDAD
                <br />
                ES NUESTRO <span className="text-yellow-400">FARO.</span>
              </h2>
              <p className="text-2xl leading-relaxed">
                Asumimos la responsabilidad de transformar y preservar la
                experiencia de la música en vivo para las generaciones futuras.
                Conscientes del impacto del entretenimiento en vivo en el
                ambiente, replanteamos estrategias a nivel energético, de
                gestión de residuos y reutilización de insumos.
              </p>
            </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <p className="text-2xl leading-relaxed mb-8">
                Creemos firmemente que las diferencias nos enriquecen y
                potencian. Por eso, implementamos diversas iniciativas que
                garantizan la accesibilidad y la comodidad de todo el público.
              </p>

              <div className="bg-white backdrop-blur-sm p-6 rounded-lg mb-6 text-2xl leading-relaxed">
                <p className="mb-4">
                  <strong>
                    Estamos comprometidos a crear un festival donde toda la
                    comunidad se sienta bienvenida y pueda disfrutar de una
                    experiencia única.
                  </strong>
                </p>
                <p>
                  Si tenés alguna sugerencia o necesitás asistencia, no dudes en
                  contactarnos a través de{" "}
                  <p className="text-purple-600 text-xl">
                    accesibilidad.enchastre@festival.com
                  </p>
                </p>
              </div>
            </motion.div>
